...
class _$LoginReqImpl implements _LoginReq {
  const _$LoginReqImpl({this.email, this.password});
...
abstract class _LoginReq implements LoginReq {
  const factory _LoginReq({final String? email, final String? password}) =
      _$LoginReqImpl;
...
class _$LoginResImpl implements _LoginRes {
  const _$LoginResImpl({this.code, this.status, this.message, this.data});
  ...
  @override
  String toString() {
    return 'LoginRes(code: $code, status: $status, message: $message, data: $data)';
  }
...
abstract class _LoginRes implements LoginRes {
  const factory _LoginRes(
      ...
      final bool? status,
      final String? message,
      final Data? data}) = _$LoginResImpl;
