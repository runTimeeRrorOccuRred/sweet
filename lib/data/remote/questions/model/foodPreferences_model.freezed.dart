...
part of 'foodPreferences_model.dart';
...
FoodPreferencesRes _$FoodPreferencesResFromJson(Map<String, dynamic> json) {
  return _FoodPreferencesRes.fromJson(json);
}

/// @nodoc
mixin _$FoodPreferencesRes {
  ...
  @JsonKey(ignore: true)
  $FoodPreferencesResCopyWith<FoodPreferencesRes> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FoodPreferencesResCopyWith<$Res> {
  factory $FoodPreferencesResCopyWith(
          FoodPreferencesRes value, $Res Function(FoodPreferencesRes) then) =
      _$FoodPreferencesResCopyWithImpl<$Res, FoodPreferencesRes>;
  @useResult
  $Res call({int? code, String? message, bool? status, List<Datum>? data});
}

/// @nodoc
class _$FoodPreferencesResCopyWithImpl<$Res, $Val extends FoodPreferencesRes>
    implements $FoodPreferencesResCopyWith<$Res> {
  _$FoodPreferencesResCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$FoodPreferencesResImplCopyWith<$Res>
    implements $FoodPreferencesResCopyWith<$Res> {
  factory _$$FoodPreferencesResImplCopyWith(_$FoodPreferencesResImpl value,
          $Res Function(_$FoodPreferencesResImpl) then) =
      __$$FoodPreferencesResImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int? code, String? message, bool? status, List<Datum>? data});
}
...
/// @nodoc
class __$$FoodPreferencesResImplCopyWithImpl<$Res>
    extends _$FoodPreferencesResCopyWithImpl<$Res, _$FoodPreferencesResImpl>
    implements _$$FoodPreferencesResImplCopyWith<$Res> {
  __$$FoodPreferencesResImplCopyWithImpl(_$FoodPreferencesResImpl _value,
      $Res Function(_$FoodPreferencesResImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FoodPreferencesResImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$FoodPreferencesResImpl implements _FoodPreferencesRes {
  const _$FoodPreferencesResImpl(
      {this.code, this.message, this.status, final List<Datum>? data})
      : _data = data;

  factory _$FoodPreferencesResImpl.fromJson(Map<String, dynamic> json) =>
      _$$FoodPreferencesResImplFromJson(json);
  ...
  @override
  String toString() {
    return 'FoodPreferencesRes(code: $code, message: $message, status: $status, data: $data)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$FoodPreferencesResImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$FoodPreferencesResImplCopyWith<_$FoodPreferencesResImpl> get copyWith =>
      __$$FoodPreferencesResImplCopyWithImpl<_$FoodPreferencesResImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$FoodPreferencesResImplToJson(
      this,
    );
  }
}

abstract class _FoodPreferencesRes implements FoodPreferencesRes {
  const factory _FoodPreferencesRes(
      {final int? code,
      final String? message,
      final bool? status,
      final List<Datum>? data}) = _$FoodPreferencesResImpl;

  factory _FoodPreferencesRes.fromJson(Map<String, dynamic> json) =
      _$FoodPreferencesResImpl.fromJson;
