...
FoodAllergieModel _$FoodAllergieModelFromJson(Map<String, dynamic> json) {
  return _FoodAllergieModel.fromJson(json);
}

/// @nodoc
mixin _$FoodAllergieModel {
  ...
  @JsonKey(ignore: true)
  $FoodAllergieModelCopyWith<FoodAllergieModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FoodAllergieModelCopyWith<$Res> {
  factory $FoodAllergieModelCopyWith(
          FoodAllergieModel value, $Res Function(FoodAllergieModel) then) =
      _$FoodAllergieModelCopyWithImpl<$Res, FoodAllergieModel>;
  @useResult
  $Res call({int? code, String? message, bool? status, List<Datum>? data});
}

/// @nodoc
class _$FoodAllergieModelCopyWithImpl<$Res, $Val extends FoodAllergieModel>
    implements $FoodAllergieModelCopyWith<$Res> {
  _$FoodAllergieModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$FoodAllergieModelImplCopyWith<$Res>
    implements $FoodAllergieModelCopyWith<$Res> {
  factory _$$FoodAllergieModelImplCopyWith(_$FoodAllergieModelImpl value,
          $Res Function(_$FoodAllergieModelImpl) then) =
      __$$FoodAllergieModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int? code, String? message, bool? status, List<Datum>? data});
}
...
/// @nodoc
class __$$FoodAllergieModelImplCopyWithImpl<$Res>
    extends _$FoodAllergieModelCopyWithImpl<$Res, _$FoodAllergieModelImpl>
    implements _$$FoodAllergieModelImplCopyWith<$Res> {
  __$$FoodAllergieModelImplCopyWithImpl(_$FoodAllergieModelImpl _value,
      $Res Function(_$FoodAllergieModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FoodAllergieModelImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$FoodAllergieModelImpl implements _FoodAllergieModel {
  const _$FoodAllergieModelImpl(
      {this.code, this.message, this.status, final List<Datum>? data})
      : _data = data;

  factory _$FoodAllergieModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$FoodAllergieModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'FoodAllergieModel(code: $code, message: $message, status: $status, data: $data)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$FoodAllergieModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$FoodAllergieModelImplCopyWith<_$FoodAllergieModelImpl> get copyWith =>
      __$$FoodAllergieModelImplCopyWithImpl<_$FoodAllergieModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$FoodAllergieModelImplToJson(
      this,
    );
  }
}

abstract class _FoodAllergieModel implements FoodAllergieModel {
  const factory _FoodAllergieModel(
      {final int? code,
      final String? message,
      final bool? status,
      final List<Datum>? data}) = _$FoodAllergieModelImpl;

  factory _FoodAllergieModel.fromJson(Map<String, dynamic> json) =
      _$FoodAllergieModelImpl.fromJson;
