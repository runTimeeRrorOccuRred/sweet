...
part of 'preferredDiet_model.dart';
...
PreferdDietRes _$PreferdDietResFromJson(Map<String, dynamic> json) {
  return _PreferdDietRes.fromJson(json);
}

/// @nodoc
mixin _$PreferdDietRes {
  ...
  @JsonKey(ignore: true)
  $PreferdDietResCopyWith<PreferdDietRes> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PreferdDietResCopyWith<$Res> {
  factory $PreferdDietResCopyWith(
          PreferdDietRes value, $Res Function(PreferdDietRes) then) =
      _$PreferdDietResCopyWithImpl<$Res, PreferdDietRes>;
  @useResult
  $Res call({int? code, String? message, bool? status, List<Datum>? data});
}

/// @nodoc
class _$PreferdDietResCopyWithImpl<$Res, $Val extends PreferdDietRes>
    implements $PreferdDietResCopyWith<$Res> {
  _$PreferdDietResCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PreferdDietResImplCopyWith<$Res>
    implements $PreferdDietResCopyWith<$Res> {
  factory _$$PreferdDietResImplCopyWith(_$PreferdDietResImpl value,
          $Res Function(_$PreferdDietResImpl) then) =
      __$$PreferdDietResImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int? code, String? message, bool? status, List<Datum>? data});
}
...
/// @nodoc
class __$$PreferdDietResImplCopyWithImpl<$Res>
    extends _$PreferdDietResCopyWithImpl<$Res, _$PreferdDietResImpl>
    implements _$$PreferdDietResImplCopyWith<$Res> {
  __$$PreferdDietResImplCopyWithImpl(
      _$PreferdDietResImpl _value, $Res Function(_$PreferdDietResImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PreferdDietResImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$PreferdDietResImpl implements _PreferdDietRes {
  const _$PreferdDietResImpl(
      {this.code, this.message, this.status, final List<Datum>? data})
      : _data = data;

  factory _$PreferdDietResImpl.fromJson(Map<String, dynamic> json) =>
      _$$PreferdDietResImplFromJson(json);
  ...
  @override
  String toString() {
    return 'PreferdDietRes(code: $code, message: $message, status: $status, data: $data)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PreferdDietResImplCopyWith<_$PreferdDietResImpl> get copyWith =>
      __$$PreferdDietResImplCopyWithImpl<_$PreferdDietResImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PreferdDietResImplToJson(
      this,
    );
  }
}

abstract class _PreferdDietRes implements PreferdDietRes {
  const factory _PreferdDietRes(
      {final int? code,
      final String? message,
      final bool? status,
      final List<Datum>? data}) = _$PreferdDietResImpl;

  factory _PreferdDietRes.fromJson(Map<String, dynamic> json) =
      _$PreferdDietResImpl.fromJson;
