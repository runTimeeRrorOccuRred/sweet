...
_$PreferdDietResImpl _$$PreferdDietResImplFromJson(Map<String, dynamic> json) =>
    _$PreferdDietResImpl(
...
Map<String, dynamic> _$$PreferdDietResImplToJson(
        _$PreferdDietResImpl instance) =>
    <String, dynamic>{
      'code': instance.code,
