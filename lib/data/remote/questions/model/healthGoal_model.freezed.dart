...
HealthGoalRes _$HealthGoalResFromJson(Map<String, dynamic> json) {
  return _HealthGoalRes.fromJson(json);
}

/// @nodoc
mixin _$HealthGoalRes {
  ...
  @JsonKey(ignore: true)
  $HealthGoalResCopyWith<HealthGoalRes> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $HealthGoalResCopyWith<$Res> {
  factory $HealthGoalResCopyWith(
          HealthGoalRes value, $Res Function(HealthGoalRes) then) =
      _$HealthGoalResCopyWithImpl<$Res, HealthGoalRes>;
  @useResult
  $Res call({int? code, String? message, bool? status, List<Datum>? data});
}

/// @nodoc
class _$HealthGoalResCopyWithImpl<$Res, $Val extends HealthGoalRes>
    implements $HealthGoalResCopyWith<$Res> {
  _$HealthGoalResCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$HealthGoalResImplCopyWith<$Res>
    implements $HealthGoalResCopyWith<$Res> {
  factory _$$HealthGoalResImplCopyWith(
          _$HealthGoalResImpl value, $Res Function(_$HealthGoalResImpl) then) =
      __$$HealthGoalResImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int? code, String? message, bool? status, List<Datum>? data});
}
...
/// @nodoc
class __$$HealthGoalResImplCopyWithImpl<$Res>
    extends _$HealthGoalResCopyWithImpl<$Res, _$HealthGoalResImpl>
    implements _$$HealthGoalResImplCopyWith<$Res> {
  __$$HealthGoalResImplCopyWithImpl(
      _$HealthGoalResImpl _value, $Res Function(_$HealthGoalResImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$HealthGoalResImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$HealthGoalResImpl implements _HealthGoalRes {
  const _$HealthGoalResImpl(
      {this.code, this.message, this.status, final List<Datum>? data})
      : _data = data;

  factory _$HealthGoalResImpl.fromJson(Map<String, dynamic> json) =>
      _$$HealthGoalResImplFromJson(json);
  ...
  @override
  String toString() {
    return 'HealthGoalRes(code: $code, message: $message, status: $status, data: $data)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$HealthGoalResImplCopyWith<_$HealthGoalResImpl> get copyWith =>
      __$$HealthGoalResImplCopyWithImpl<_$HealthGoalResImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$HealthGoalResImplToJson(
      this,
    );
  }
}

abstract class _HealthGoalRes implements HealthGoalRes {
  const factory _HealthGoalRes(
      {final int? code,
      final String? message,
      final bool? status,
      final List<Datum>? data}) = _$HealthGoalResImpl;

  factory _HealthGoalRes.fromJson(Map<String, dynamic> json) =
      _$HealthGoalResImpl.fromJson;
